...
gosu logstash logstash -f /config-dir/logstash.conf -r
consul-template -consul=$CONSUL_URL -template="/templates/logstash.ctmpl:/config-dir/logstash.conf:gosu logstash logstash -f /config-dir/logstash.conf -r"
